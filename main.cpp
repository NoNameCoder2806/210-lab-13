...
void displayArray(const vector<double>& gpaVector);
...
int main()
{
    ...
    cout << " - Array size: " << gpaVector.size() << endl;
    cout << endl;
    
    // Display all the gpa in the vector
    cout << "Original array: ";
    displayArray(gpaVector);
    cout << endl;
...
/*
    ...
    Arguments: 
        - gpaVector: reference to the std::array<double> that will store the data
